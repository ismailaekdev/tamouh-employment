...
@section('description',
    __('Get in touch with Tamouh Employment for manpower supply, recruitment services, and staffing
    support across the UAE. We\'re here to assist employers and job seekers alike.'))
@section('og_title', __('Your Workforce Partner Awaits'))
@section('og_description',
    __('Get in touch with Tamouh Employment for manpower supply, recruitment services, and
    staffing support across the UAE. We\'re here to assist employers and job seekers alike.'))
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
            <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-100 rounded-2xl">
                <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                    src="{{ asset('images/contact.jpg') }}" alt="{{ __('Contact Tamouh Employment') }}">
            </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                        <div class="flex gap-4">
                            ...
                            <div class="grow">
                                ...
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="mailto:info@tamouhemploymentuae9.ae">
                                        info@tamouhemploymentuae9.ae
                                    </a>
                                </p>
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="mailto:info.tamouh@gmail.com">
                                        info.tamouh@gmail.com
                                    </a>
                                </p>
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="mailto:Oper@tamouhemploymentuae9.ae">
                                        Oper@tamouhemploymentuae9.ae
                                    </a>
                                </p>
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="mailto:Sales@tamouhemploymentuae9.ae">
                                        Sales@tamouhemploymentuae9.ae
                                    </a>
                                </p>
                                <p>
                                    <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="mailto:CEO@tamouhemploymentuae9.ae">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="grow">
                                ...
                                <p>
                                    <a dir="ltr"
                                        class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-1 before:w-full before:h-1 before:bg-green-400 hover:before:bg-red-400 focus:outline-hidden focus:before:bg-red-400"
                                        href="tel:++97126331559">
                                        +971 2 6331 559
                                    </a>
                                </p>
                            </div>
