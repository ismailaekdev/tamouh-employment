...
<div class="overflow-hidden bg-neutral-900">
  <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
    <h1 class="font-semibold text-white text-5xl md:text-6xl">
      <span class="text-[#ff0] ">Our services</span>     </h1>
    <div class="mt-5 max-w-4xl">
      <p class="text-neutral-400 text-lg">
        We provide customized, efficient manpower solutions that connect top talent with leading businesses across the UAE. Whether you need short-term help or long-term recruitment, Tamouh delivers skilled professionals with ease and reliability.
      </p>
    </div>
  </div>
</div>
