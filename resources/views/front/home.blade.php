            ...
            <div class="flex flex-col items-center justify-between py-8  lg:py-16">
                ...
                <div class="flex justify-center gap-4">
                    <div class="text-center">
                        <a href="{{ route('front.contact') }}" class="inline-flex justify-center items-center gap-x-2 text-center bg-primary-700 hover:bg-primary-800 shadow-lg shadow-transparent border border-transparent text-white text-sm font-medium rounded-full focus:outline-hidden py-3 px-6">
                            {{ __('Get Started') }}
