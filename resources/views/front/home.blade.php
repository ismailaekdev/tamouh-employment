...
@section('content')
    <div class="relative overflow-hidden g-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply rtl-bg-flip"
        style="background-image: url({{ asset('images/hero-home.jpg') }});">
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between py-8  lg:py-16">
                <div class="max-w-2xl text-center">
                    <h1
                        class="mb-6 text-2xl md:text-4xl font-extrabold tracking-tight text-gray-200 sm:text-5xl lg:text-6xl">
                ...
                <div class="flex justify-center gap-4">
                    <div class="text-center">
                        <a class="inline-flex justify-center items-center gap-x-2 text-center bg-primary-600 hover:bg-primary-700 shadow-lg shadow-transparent border border-transparent text-white text-sm font-medium rounded-full focus:outline-hidden py-3 px-6"
                            href="#">
                            {{ __('Get Started') }}
                            <svg class="shrink-0 size-4 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <a href="{{ route('front.contact') }}"
                        class="py-3 px-6 text-sm inline-flex items-center justify-center rounded-full border-2 border-white bg-transparent font-medium text-white transition-colors hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2">
                        {{ __('Contact Us') }}
                    </a>
                </div>
            </div>
    ...
    <section class="bg-white ">
        <div class="py-4 px-4 mx-auto max-w-screen-xl text-center sm:py-8 lg:px-6">
            ...
            <div class="mt-8 lg:mt-12 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <svg class="mx-auto mb-4 w-12 h-12 text-primary-600" aria-hidden="true"
                ...
                <div>
                    <svg class="mx-auto mb-4 w-12 h-12 text-primary-600" fill="currentColor" viewBox="0 0 20 20"
                    ...
                    <p class="mb-4 text-gray-500">{{ __('Recruitment, visa, payroll & accommodation under one roof.') }}
                    </p>
                </div>
                <div>
                    <svg class="mx-auto mb-4 w-12 h-12 text-primary-600" fill="currentColor" viewBox="0 0 20 20"
    ...
    <section class="bg-white ">
        <div class="gap-16 items-center py-4 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-8 lg:px-6">
            ...
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="{{ asset('images/about-1.jpg') }}"
                    alt="{{ __('UAE manpower supply') }}">
                <img class="mt-4 w-full lg:mt-10 rounded-lg" src="{{ asset('images/about-2.jpg') }}"
                    alt="{{ __('UAE employment agency') }}">
            </div>
        </div>
    </section>
        ...
        <div class="max-w-5xl px-4 xl:px-0 py-4 lg:pt-8 lg:py-8 mx-auto">
            <div class="mb-4 lg:mb-8">
                <h2 class=" font-semibold text-2xl md:text-4xl md:leading-tight">
                    {{ __('Connecting Ambition with Opportunity') }}</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
                <div class="aspect-w-16 aspect-h-9 lg:aspect-none">
                    <img class="w-full object-cover rounded-xl" src="{{ asset('images/vision.jpg') }}"
                        alt="{{ __('UAE manpower supply') }}">
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-x-5 ms-1">
                        <div
                            ...
                            <div class="relative z-10 size-8 flex justify-center items-center">
                                <span
                                    class="flex shrink-0 justify-center items-center size-8 border border-neutral-800 text-primary-600 font-semibold text-xs uppercase rounded-full">
                                    1
                                </span>
                            </div>
                        </div>
                    ...
                    <a class="text-white group inline-flex items-center gap-x-2 py-2 px-3 bg-primary-600 font-medium text-sm rounded-full focus:outline-hidden"
                        href="tel:+97124433622">
                        <svg class="shrink-0 size-4 rtl:-rotate-90" xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path
        ...
        <div class="py-4 px-4 mx-auto max-w-screen-xl text-center sm:py-8 lg:px-6">
            ...
            <div class="mt-8 lg:mt-16 mb-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                <div>
                    <div class="inline-flex justify-center items-center mb-6 w-24 h-24 rounded-lg bg-primary-100 ">
                        <svg class="mx-auto w-16 h-16 text-primary-600" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <div class="inline-flex justify-center items-center mb-6 w-24 h-24 bg-purple-100 rounded-lg ">
                        <svg class="mx-auto w-16 h-16 text-purple-600 " fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
            ...
            <p class="text-center">
                <a href="" class="inline-flex items-center font-medium text-primary-600 hover:text-primary-700">
                    ...
                    <svg class="ml-1 w-5 h-5 rtl:rotate-180" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl text-center sm:py-8 lg:px-6">
        ...
        <p class="text-gray-500 sm:text-xl lg:px-48">
            {{ __('Discover how Tamouh Employment empowers professionals and craftsmen across the UAE.') }}
        </p>
    </div>
    ...
    <section class="bg-white">
        <div class="py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-6">
            ...
            <div>
                <blockquote>
                    <p
                        class="text-gray-500 text-sm md:text-xl md:leading-normal text-justify rtl:md:text-right md:text-left mb-4">
                    ...
                    <div class="flex items-center gap-x-4 mt-6 justify-center md:justify-end">
                        ...
                        <p class="md:text-lg">
                            <span class="font-semibold text-primary-400">{{ __('Engr. Mohamed El Bahrawy') }},</span>
                            <span class="text-neutral-500">{{ __('CEO GMAIL:') }}</span>
                        </p>
                        <p class="md:text-lg">
                            <span
                                class="text-gray-500 text-sm md:text-xl md:leading-normal text-justify rtl:md:text-right md:text-left mb-4">{{ __('CEO@tamouhemploymentuae9.ae') }}</span>
                        </p>
                    </div>
                </blockquote>
            </div>
    ...
    <section class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl mx-auto text-center mb-6">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">{{ __('Certified for Excellence') }}
            </h2>
            <p class="text-gray-500 sm:text-xl">
                {{ __('Tamouh Employment is ISO-certified, reflecting our commitment to quality and reliability in manpower services across the UAE.') }}
            </p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="h-full bg-white border border-gray-200 shadow-2xs rounded-xl">
                <div class="flex flex-col justify-center items-center overflow-hidden rounded-t-xl">
                    <img class="w-full h-[300px] md:h-[400px] lg:h-[500px] object-contain"
                        src="{{ asset('images/ISO-9001-2015.jpg') }}" alt="">
                </div>
                <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
                    <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                        href="{{ asset('pdf/ISO-9001-2015.pdf') }}" download>
                        {{ __('Download') }}
                    </a>
                </div>
            </div>
            ...
            <div class="h-full bg-white border border-gray-200 shadow-2xs rounded-xl">
                <div class="flex flex-col justify-center items-center overflow-hidden rounded-t-xl">
                    <img class="w-full h-[300px] md:h-[400px] lg:h-[500px] object-contain"
                        src="{{ asset('images/ISO-14001-2015.jpg') }}" alt="">
                </div>
                <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
                    <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                        href="{{ asset('pdf/ISO-14001-2015.pdf') }}" download>
                        {{ __('Download') }}
                    </a>
                </div>
            </div>
            ...
            <div class="h-full bg-white border border-gray-200 shadow-2xs rounded-xl">
                <div class="flex flex-col justify-center items-center overflow-hidden rounded-t-xl">
                    <img class="w-full h-[300px] md:h-[400px] lg:h-[500px] object-contain"
                        src="{{ asset('images/ISO-45001-2018.jpg') }}" alt="">
                </div>
                <div class="mt-auto flex border-t border-gray-200 divide-x divide-gray-200">
                    <a class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-ee-xl bg-white text-gray-800 shadow-2xs hover:bg-gray-50 focus:outline-hidden focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                        href="{{ asset('pdf/ISO-45001-2018.pdf') }}" download>
                        {{ __('Download') }}
                    </a>
                </div>
            </div>
    ...
    <section class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="max-w-2xl mx-auto text-center mb-6">
            ...
            <p class="text-gray-500 sm:text-xl">
                {{ __('Trusted by leading companies across the UAE for reliable and efficient manpower solutions.') }}</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-5 gap-x-6">
            <img class="py-3 lg:py-5 w-24 h-auto md:w-20 lg:w-32 mx-auto" src="{{ asset('images/logos/specoiii.png') }}"
                alt="specoiii logo" />
            <img class="py-3 lg:py-5 w-24 h-auto md:w-20 lg:w-32 mx-auto" src="{{ asset('images/logos/nbhi.png') }}"
                alt="nbhi logo" />
            <img class="py-3 lg:py-5 w-24 h-auto md:w-20 lg:w-32 mx-auto" src="{{ asset('images/logos/ccc.png') }}"
                alt="ccc logo" />
            <img class="py-3 lg:py-5 w-24 h-auto md:w-20 lg:w-32 mx-auto" src="{{ asset('images/logos/nurol.png') }}"
                alt="Nurol LLC logo" />
            <img class="py-3 lg:py-5 w-24 h-auto md:w-20 lg:w-32 mx-auto" src="{{ asset('images/logos/raq.png') }}"
                alt="RAQ LLC logo" />
        </div>
    </section>
@endsection
