...
<html lang="{{ str_replace('_', '-', locale()) }}"@if(locale() === 'ar') dir="rtl"@endif>
    ...
    <body @class([
        ...
        <a href="https://wa.me/971547925889?text={{ __('Hello%2C%20I%E2%80%99m%20contacting%20you%20from%20the%20Tamouh%20Employment%20website.') }}" target="_blank" rel="noreferrer noopener" class="fixed bottom-4 right-4 z-50 inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#25d366]">
